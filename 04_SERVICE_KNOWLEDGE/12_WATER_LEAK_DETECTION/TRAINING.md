# Water Leak Detection Training Requirements

## Document Information

- **Service ID:** `SVC-WATER-LEAK-DETECTION`
- **Status:** Draft — Training Not Authorized


## Purpose

Define evidence and assessment needed before an agent, provider, or technician
is represented as competent to support or deliver Water Leak Detection.

## Training Evidence Register

- Approved scope and boundaries
- Role-specific competency requirements
- Hazards, controls, truthful-claim rules, and stop-work criteria
- Documentation, evidence, privacy, and sign-off requirements
- Assessment method, pass criteria, refresher triggers, and authorization owner

This file does not claim that any person holds a qualification, license,
