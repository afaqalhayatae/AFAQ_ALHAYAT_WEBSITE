# Drain Unblocking Customer Guide
...
Prepare a customer-facing guide only from an approved service scope and
approved safety controls.

## Questions to Resolve

- What information, access, permissions, and preparation are required?
- What disruption, limitations, or customer responsibilities apply?
- What completion evidence and acceptance process will be used?
- What after-service care and escalation channels are approved?

## Publication Guardrail

Do not publish preparation, re-entry, safety, duration, result, warranty, or
aftercare instructions until the relevant evidence gate is closed.
