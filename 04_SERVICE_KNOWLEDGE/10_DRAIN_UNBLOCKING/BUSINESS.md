# Drain Unblocking Business Knowledge
...
Define the commercial identity and boundaries of Drain Unblocking without inventing
scope, capability, availability, pricing, or warranty facts.

## Confirmed Identity

- **Canonical name:** Drain Unblocking
- **Canonical ID:** `SVC-DRAIN-UNBLOCKING`

## Owner Input Register

- Customer segments and problems addressed
- Value proposition and approved differentiators
- Included, excluded, and optional scope
- Booking constraints and commercial model
- Pricing factors, cancellation, rework, and warranty policy
- Approved claims and evidence supporting each claim
