...
| Phone, WhatsApp, email, domain, address, hours | `02_BRAND/CONTACT_INFORMATION.md` — **check Status field before answering; if Draft/Unverified, do not state the value as fact** |
| Coverage area / "do you serve X city" | `03_MARKET/SERVICE_AREAS.md` — **not yet finalized as of this writing; see Answer Policy for how to handle this** |
